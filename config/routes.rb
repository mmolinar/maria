Rails.application.routes.draw do
  ...
  get 'pages/muffins_platano' => 'pages#muffins_platano'
  
  get 'pages/pure_datiles' => 'pages#pure_datiles'
  
  get 'pages/carne_borgona' => 'pages#carne_borgona'
  
  get 'pages/agua_de_sabor' => 'pages#agua_de_sabor'
  
  get 'pages/hachis_parmentier' => 'pages#hachis_parmentier'
  
  get 'pages/muffins_calabacita' => 'pages#muffins_calabacita'
  
  get 'pages/introduccion_de_sabores' => 'pages#introduccion_de_sabores'
  
  get 'pages/tortitas_garbanzo' => 'pages#tortitas_garbanzo'
  ...
  get 'pages/risotto_berenjena' => 'pages#risotto_berenjena'
